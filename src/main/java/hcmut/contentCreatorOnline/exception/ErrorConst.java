...
public class ErrorConst {
    ...
    public static final ErrorConstParams FORBIDDEN = new ErrorConstParams(
            HttpStatus.FORBIDDEN,
            "400003",
            OccurredPoint.APP.toString(),
            "Forbidden request");

    public static final ErrorConstParams UNAUTHORIZED = new ErrorConstParams(
            HttpStatus.UNAUTHORIZED,
            "400001",
            OccurredPoint.AUTH.toString(),
            "Unauthorized");

    public static final ErrorConstParams RESOURCE_NOT_FOUND = new ErrorConstParams(

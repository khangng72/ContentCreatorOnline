...
public class commenline implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        repositJpa
                .save(new Creation((long) 1, "creationName1jpa", dateFormat.parse("01/01/2024"), true, true,
                        1000000));
        repositJpa
                .save(new Creation((long) 2, "creationName2jpa", dateFormat.parse("01/01/2024"), true, true,
                        1000000));
        repositJpa
                .save(new Creation((long) 3, "creationName2jpa", dateFormat.parse("01/01/2024"), true, true,
                        1000000));
        repositJpa
                .save(new Creation((long) 5, "creationName5jpa",
                        dateFormat.parse("01/01/2024"), true, true, 1000000));
        repositJpa
                .save(new Creation((long) 4, "creationName2", dateFormat.parse("01/01/2024"), true, true, 1000000));
